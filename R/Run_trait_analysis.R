...
#       filter(species != "Pseudonigrita cabanisi", 
#              !is.na(avg.r))
...
# brinla::bri.lmresid.plot(model_prop_change)  
...
# brinla::bri.lmresid.plot(model_col_log)  
...
# brinla::bri.lmresid.plot(model_loss_log)  
...
# brinla::bri.lmresid.plot(model_prop_change_breadth)  
...
# brinla::bri.lmresid.plot(model_col_log_breadth)  
...
# brinla::bri.lmresid.plot(model_loss_log_breadth)  
